...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <a href="<c:url  value="/destination/add"/>"
               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                <i class="fas fa-download fa-sm text-white-60"></i><span
                    style="font-size: 160%; ">Add Destination</span>
            </a>
            <a href="<c:url  value="/destination/list"/>"
               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                <i class="fas fa-download fa-sm text-white-60"></i><span
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <div class="card-body">
                    <form:form method="post" modelAttribute="destination">
                        <form:hidden path="id"/><br/>
                        <div class="form-group">
                            <label for="nameOfDestination"><span style="font-size: 110%; color: darkslateblue "><b>Destination:</b></span></label>
                            <form:input path="nameOfDestination"/><br/>
                            <form:errors path="nameOfDestination" cssStyle="color: #e02d1b"/>
                        </div>
                        <div class="form-group">
                        ...
                        <a href="<c:url  value="/destination/list"/>" class="btn btn-primary">
