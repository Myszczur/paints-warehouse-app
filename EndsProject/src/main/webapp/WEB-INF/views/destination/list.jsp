...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">List of Paints Destinations</h4>
        </div>
        <div class="card-body">
                ...
                <table class="table">
                    ...
                    <c:forEach items="${destination}" var="destination">
                        <tr>
                            ...
                            <td><strong>${destination.nameOfDestination}</strong></td>
                            <td>
                                <a href='<c:url value="/destination/show/${destination.id}"/>'><strong>Show</strong></a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
