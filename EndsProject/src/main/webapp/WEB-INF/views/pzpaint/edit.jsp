            ...
            <a href="<c:url  value="/pzpaint/list"/>"
               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                <i class="fas fa-download fa-sm text-white-60"></i><span
                    style="font-size: 160%; ">PZ - list</span>
            </a>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h4 class="m-0 font-weight-bold text-primary"><span
                        style="font-size: 115%; ">PZ - edit</span></h4>
                <div class="card-body">
                    <form:form method="post" modelAttribute="pzpaint">
                        <form:hidden path="id"/><br/>

                        <div class="form-group">
                            <tr>
                                <td><label><h4><span style="color:darkblue; "><b>Name:</b></span></h4></label>
                                    <h5><span style="font-size: 130%">${pzpaint.name}</span></h5>
                        ...
                        <div class="form-group">
                            <tr>
                                <td><label><h4><span style="color:darkblue; "><b>Destination:</b></span></h4></label>
                                    <h5><span style="font-size: 110%">${pzpaint.destination.nameOfDestination}</span>
                        ...
                        <div class="form-group">
                            <tr>
                                <td><label><h4><span style="color:darkblue; "><b>Description:</b></span></h4></label>
                                    <h5><span style="font-size: 130%">${pzpaint.description}</span></h5></td>
                        ...
                        <div class="form-group">
                            <tr>
                                <td><label><h4><span style="color:darkblue; "><b>Ingredients:</b></span></h4></label>
                                    <h5><span style="font-size: 130%">${pzpaint.ingredients}</span></h5>
