    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary"><span
                    style="font-size: 115%; ">PZ - details</span></h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table">
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>Id:</b></span></h4></label>
                                <label><h5><span style="font-size: 130%">${pzpaint.id}</span></h5></label></td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>Name:</b></span></h4></label>
                                <label><h5><span style="font-size: 130%">${pzpaint.name}</span></h5></label></td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                        <td><label><h4><span style="color:darkblue; "><b>Paints Type:</b></span></h4></label>
                            <h5>
                                <c:forEach items="${pzpaint.paintsType}" var="paintsType">
                                    ${paintsType.type},
                                </c:forEach>
                            </h5></td>
                    ...
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>Destination:</b></span></h4></label>
                                <h5><span style="font-size: 130%">${pzpaint.destination.nameOfDestination}</span>
                                </h5></td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>quantity:</b></span></h4></label>
                                <label><h5><span style="font-size: 130%">${pzpaint.quantity}</span></h5></label></td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>description:</b></span></h4></label>
                                <label><h5><span style="font-size: 130%">${pzpaint.description}</span></h5></label>
                            </td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>delivery:</b></span></h4></label>
                                <label><h5><span style="font-size: 130%">${pzpaint.incomeOn}</span></h5></label>
                            </td>
                        </tr>
                    </div>
                    ...
                    <div>
                        <tr>
                            <th>
<%--                                <a href="<c:url value="/pzpaint/edit?id=${pzpaint.id}"/>"--%>
<%--                                   class="btn btn-primary">--%>
<%--                                    <i class="fas fa-download fa-sm text-white-60"></i><b>Edit</b> </a>--%>
                                <a href="<c:url value="/pzpaint/del/${pzpaint.id}"/>"
