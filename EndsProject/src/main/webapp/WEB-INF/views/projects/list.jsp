...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">List of Projects</h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table">
                    <tr>
                        ...
                        <th><h4><strong>Ends Date</strong></h4></th>
                        <th><h4><strong>Action</strong></h4></th>
                    </tr>
                    <c:forEach items="${projects}" var="projects">
                        <tr>
                            <td><strong>${projects.id}</strong></td>
                            <td><strong>${projects.nameOfProject}</strong></td>
                            <td><strong>${projects.address}</strong></td>
                            <td><strong>${projects.endsDate}</strong></td>
                            <td>
                                <a href='<c:url value="/projects/show/${projects.id}"/>'><strong>Show</strong></a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
