            ...
            <a href="<c:url  value="/projects/add"/>"
               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                <i class="fas fa-download fa-sm text-white-60"></i><span
                    style="font-size: 160%; ">Add new Project</span>
            </a>
                ...
                <div class="card-body">
                    <form:form method="post" modelAttribute="projects">
                        ...
                        <div class="form-group">
                            <label for="nameOfProject"><span style="font-size: 110%; color: darkslateblue "><b>Paint Type:</b></span></label>
                        ...
                        <div class="form-group">
                            <label for="address"><span
                                    style="font-size: 110%;color: darkslateblue "><b>address:</b></span></label>
                        ...
                        <a href="<c:url  value="/projects/list"/>" class="btn btn-primary">
