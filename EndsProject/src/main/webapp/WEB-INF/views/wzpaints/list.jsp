...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h4 class="m-0 font-weight-bold text-primary">WZ -  paints list</h4>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        <table class="table">
          <tr>
            ...
            <th><h4><strong>Release</strong></h4></th>
            <th><h4><strong>Project</strong></h4></th>
            <th><h4><strong>Action</strong></h4></th>
          </tr>
          <c:forEach items="${wzpaints}" var="wzpaints">
            <tr>
              <td><strong>${wzpaints.id}</strong></td>
              <td><strong>${wzpaints.name}</strong></td>
              <td><strong>${wzpaints.paintsType.type}</strong></td>
              <td><strong>-${wzpaints.quantity}L</strong></td>
              <td><strong>${wzpaints.releaseOn}</strong></td>
              <td><strong>${wzpaints.projects.nameOfProject}</strong></td>
              <td>
                <a href='<c:url value="/wzpaints/show/${wzpaints.id}"/>'><strong>Show</strong></a>
              </td>
            </tr>
          </c:forEach>
        </table>
