...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="<c:url  value="/paints-type/add"/>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            <i class="fas fa-download fa-sm text-white-60"></i><span style="font-size: 160%; ">Add Paints Type</span>
        </a>
        <a href="<c:url  value="/paints-type/list"/>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            <i class="fas fa-download fa-sm text-white-60"></i><span
                style="font-size: 160%; ">List of Paints Type</span>
        </a>
                    ...
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>Id:</b></span></h4></label>
                                <label><h5><span style="font-size: 130%">${paintsType.id}</span></h5></label></td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>Type:</b></span></h4></label>
                                <label><h5><span style="font-size: 130%">${paintsType.type}</span></h5></label>
                            </td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>Description:</b></span></h4></label>
                                <label><h5><span style="font-size: 130%">${paintsType.description}</span></h5></label>
                            </td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>Updated:</b></span></h4></label>
                                <label><h5><span style="font-size: 130%">${paintsType.updatedOn}</span></h5></label>
                            </td>
                        </tr>
                    </div>
                    <div>
                        <tr>
                            <th>
                                <a href="<c:url value="/paints-type/edit?id=${paintsType.id}"/>"
                                   class="btn btn-primary">
                                    <i class="fas fa-download fa-sm text-white-60"></i><b>Edit</b> </a>
<%--                                <a href="<c:url value="/paints-type/del/${destinations.id}"/>"--%>
