...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="<c:url  value="/paints-type/list"/>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            <i class="fas fa-download fa-sm text-white-60"></i><span style="font-size: 160%; ">List of Paints Type</span>
        </a>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">Add new Type</h4>
        </div>
        <div class="card-body">
            <form:form method="post" modelAttribute="paintsType">
                <div class="form-group">
                    <label for="type"><strong>Paint Type:</strong></label>
