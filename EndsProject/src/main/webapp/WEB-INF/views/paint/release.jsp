...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <a href="<c:url  value="/wzpaints/list"/>"
               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                <i class="fas fa-download fa-sm text-white-60"></i><span
                    style="font-size: 160%; ">WZ Paint list</span>
            </a>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h4 class="m-0 font-weight-bold text-primary"><span
                        style="font-size: 115%; ">Paint WZ</span></h4>
                <div class="card-body">

                        <div class="form-group">
                            <tr>
                                <td><label><h4><span style="color:darkblue; "><b>Id:</b></span></h4></label>
                                    <h5><span style="font-size: 130%">${paints.id}</span></h5>
                            </tr>
                        </div>
                        <div class="form-group">
                            <tr>
                    ...
                    <form:form method="post" modelAttribute="wzpaints">
                    <form:hidden path="id"/><br/>
                        ...
                        <div class="form-group">
                            <label for="projects"><strong>project:</strong></label>
                            <form:select path="projects" items="${project}"
                                         itemLabel="nameOfProject" itemValue="id"/><br/>
                        </div>
                            <div class="form-group">
                                <label for="paintsType"><strong>project:</strong></label>
                                <form:select path="paintsType" items="${paints.paintsType}"
