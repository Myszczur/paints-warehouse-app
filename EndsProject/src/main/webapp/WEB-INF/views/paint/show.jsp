        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>Quantity:</b></span></h4></label>
                                <h5><span style="font-size: 130%">${paints.quantity}L</span></h5></td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                    ...
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>Added:</b></span></h4></label>
                                <h5><span style="font-size: 130%">${paints.added}</span></h5>
                            </td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                            <td><label><h4><span style="color:darkblue; "><b>Updated:</b></span></h4></label>
                                <h5><span style="font-size: 130%">${paints.updatedOn}</span></h5>
                            </td>
                        </tr>
                    </div>
                    <div>
                        <tr>
                            <th>
                                <a href="<c:url value="/paint/edit?id=${paints.id}"/>"
                                   class="btn btn-primary">
                                    <i class="fas fa-download fa-sm text-white-60"></i><b>Edit</b> </a>
                                <a href="<c:url value="/paint/del/${paints.id}"/>"
